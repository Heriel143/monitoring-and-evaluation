                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h1 class="text-xl font-bold card-title">Add Project</h1>
                            @if (count($errors))
                                @foreach ($errors->all() as $error)
                                    <p class="alert alert-danger">{{ $error }}</p>
                                @endforeach
                            @endif
                            <form action="{{ route('project.add') }}" method="post" class="mt-4" id="myForm">
                                @csrf
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8 form-group">
                                        <input class="form-control" type="number" name="budget" id="name">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Implementing
                                        Mechanism:</label>
                                    <div class="col-sm-8 form-group">
                                        <input class="form-control" type="text" name="implementing_mechanism"
                                            id="name">
                                    </div>
                                </div>
